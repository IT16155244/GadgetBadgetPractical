...
/**
 * Servlet implementation class UserManagementAPI
 */
@WebServlet("/UserManagementAPI")
public class UserManagementAPI extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String output = userObject.insertUser(
	...
	protected void doPut(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String output = userObject.updateUser(
	...
	protected void doDelete(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// TODO Auto-generated method stub
		Map paras = getParasMap(request);
		String output = userObject.deleteUser(paras.get("userID").toString());
		response.getWriter().write(output);
	}
